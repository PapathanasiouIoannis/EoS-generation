...
extended radial diagnostics are unsupported in 1.1; their absence is expected
...
the same five combined dataset figures as the hadronic dataset notebook:
pressure, sound speed, M–R, k2–M, and Lambda–M. The adapter consumes sealed
tables and performs zero scientific solver calls.
